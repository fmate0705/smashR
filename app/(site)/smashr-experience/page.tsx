...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    'Mi történik a forró lapon? A smash technika lépésről lépésre: friss marhagolyó, egyetlen mozdulat, karamellizálódó kéreg, csipkés ropogós perem.',
  canonical: '/smashr-experience',
  shareDescription: 'A smash technika lépésről lépésre: hús, lap, mozdulat, perem.',
});
...
export default function ExperiencePage() {
  return (
    <>
      ...
      <BeigeSection spacing="loose" ariaLabelledBy="anatomia-cim" waveTop={false}>
        <Container>
      ...
      <LocationSection heading="Nézd meg élőben." />
    </>
  );
}
