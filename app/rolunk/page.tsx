...
export const metadata: Metadata = {
  ...
  description:
    'A SmashR egy pult, egy forró lap és egy rövid étlap Budapest XXIII. kerületében. Friss marhahús, aznap vágott zöldség, saját szósz — és egy mozdulat, amit nem rontunk el.',
  alternates: { canonical: '/rolunk' },
  openGraph: {
    url: '/rolunk',
    title: 'Rólunk — SmashR',
    description: 'Egy pult, egy forró lap, egy rövid étlap. Ez a SmashR.',
  },
};
...
export default function AboutPage() {
  return (
    <>
      ...
      <LocationSection heading="Itt találsz minket." tearInto="tile" />
    </>
  );
}
